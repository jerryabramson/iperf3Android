...
@Composable
fun HostInputRowPreview(colors: androidx.compose.material3.TextFieldColors = textFieldColors()) {
    Column() {
        Row(
            verticalAlignment = Alignment.Top, modifier = Modifier.fillMaxWidth().padding(top =  4.dp, bottom = 4.dp).height(height = 50.dp),
        ) {
            TextField(
                ...
                modifier = Modifier.padding(end = 4.dp).width(width = 160.dp),
                label = {
                    Text(
                        "iPerf3 Server[:port]",
                        style = MaterialTheme.typography.bodySmall,
            ...
            GenericNumericField(
                ...
                placeholder = "10",
                label = "Time",
                modifier = Modifier.padding(end = 4.dp).width(width = 70.dp),
                colors = colors
            )
        }
        Row(
            verticalAlignment = Alignment.Bottom, modifier = Modifier.fillMaxWidth().padding(top =  4.dp).height(height = 50.dp),
        ) {
